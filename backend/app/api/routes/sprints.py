...
def create_sprint(sprint: SprintCreate, project_id: int, session: Session = Depends(get_session)):
...
def get_project_sprints(project_id: int, session: Session = Depends(get_session)):
